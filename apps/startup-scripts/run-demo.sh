...
echo "Power of the Justins"

# Store the current working directory
ORIGINAL_PWD=$(pwd)

# Export the environment variables
# export CONFIG_HOME=/Users/jjarae/source/demo/cdl/moderizing-brownfield-apps/apps/brownfield-app/config
export CONFIG_HOME=/home/ubuntu/brownfield-app/config
...
vault agent -config vault-agent-config-approle.hcl -log-level info &
VAULT_AGENT_PID=$!
